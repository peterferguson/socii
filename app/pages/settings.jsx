      ...
      <div className="w-full sm:w-1/2 xl:w-1/3">
        <div className="mb-4">
          <div className="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
            ...
            <span className="flex items-center px-2 py-1 mt-4 text-xs font-semibold text-yellow-500 bg-yellow-100 w-36 rounded-md">
              DUE DATE : 18 JUN
            </span>
          </div>
        </div>
                  ...
                  <table className="w-full dark:text-white">
                    ...
                    <tr>
                      ...
                      <td className="relative px-1 py-3 text-center cursor-pointer hover:text-blue-500">
                        3
                        <span className="absolute bottom-0 w-2 h-2 bg-blue-500 rounded-full left-1/2 transform -translate-x-1/2"></span>
                      </td>
                      <td className="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">
                        4
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="relative px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">
                        25
                        <span className="absolute bottom-0 w-2 h-2 bg-red-500 rounded-full left-1/2 transform -translate-x-1/2"></span>
                      </td>
                      <td className="px-2 py-3 text-center cursor-pointer md:px-3 hover:text-blue-500">
                        26
                      </td>
