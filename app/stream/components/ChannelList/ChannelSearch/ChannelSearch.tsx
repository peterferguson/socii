// ! SOURCE: https://github.com/GetStream/stream-chat-react/blob/master/src/components/ChannelSearch/ChannelSearch.tsx
...
> = {
  ...
  DropdownContainer?: React.ComponentType<
    DropdownContainerProps<At, Ch, Co, Ev, Me, Re, Us>
  >
  ...
  SearchResultItem?: React.ComponentType<
    SearchResultItemProps<At, Ch, Co, Ev, Me, Re, Us>
  >
...
>(
  ...
  const [results, setResults] = useState<
    Array<ChannelOrUserResponse<At, Ch, Co, Ev, Me, Re, Us>>
  >([])
