...
class ObservableAccountsApi {
    ...
    accountsAccountIdDocumentsUploadPost(accountId, documentUpload, options) {
        ...
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_1.mergeMap((ctx) => middleware.pre(ctx)));
        }
        return middlewarePreObservable
            .pipe(rxjsStub_1.mergeMap((ctx) => this.configuration.httpApi.send(ctx)))
            .pipe(rxjsStub_1.mergeMap((response) => {
            let middlewarePostObservable = rxjsStub_1.of(response);
            for (let middleware of this.configuration.middleware) {
                middlewarePostObservable = middlewarePostObservable.pipe(rxjsStub_1.mergeMap((rsp) => middleware.post(rsp)));
            }
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsAccountIdDocumentsUploadPost(rsp)));
        }));
    }
    /**
    ...
    accountsActivitiesActivityTypeGet(activityType, date, until, after, direction, accountId, pageSize, pageToken, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsActivitiesActivityTypeGet(rsp)));
        }));
    }
    /**
    ...
    accountsActivitiesGet(date, until, after, direction, accountId, pageSize, pageToken, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsActivitiesGet(rsp)));
        }));
    }
    /**
    ...
    accountsGet(query, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsGet(rsp)));
        }));
    }
    /**
     * Create an account
    ...
    accountsPost(accountCreationObject, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsPost(rsp)));
        }));
    }
    /**
    ...
    deleteAccount(accountId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteAccount(rsp)));
        }));
    }
    /**
    ...
    deleteAchRelationship(accountId, achRelationshipId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteAchRelationship(rsp)));
        }));
    }
    /**
    ...
    deleteRecipientBank(accountId, bankId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteRecipientBank(rsp)));
        }));
    }
    /**
    ...
    deleteTransfer(accountId, transferId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteTransfer(rsp)));
        }));
    }
    /**
    ...
    eventsAccountsStatusGet(since, until, sinceId, untilId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.eventsAccountsStatusGet(rsp)));
        }));
    }
    /**
    ...
    getAccount(accountId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getAccount(rsp)));
        }));
    }
    /**
    ...
    getAchRelationships(accountId, statuses, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getAchRelationships(rsp)));
        }));
    }
    /**
    ...
    getRecipientBanks(accountId, status, bankName, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getRecipientBanks(rsp)));
        }));
    }
    /**
    ...
    getTradingAccount(accountId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getTradingAccount(rsp)));
        }));
    }
    /**
    ...
    getTransfers(accountId, direction, limit, offset, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getTransfers(rsp)));
        }));
    }
    /**
     * Update an account
    ...
    patchAccount(accountId, accountUpdate, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.patchAccount(rsp)));
        }));
    }
    /**
    ...
    postAchRelationships(accountId, aCHRelationshipData, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.postAchRelationships(rsp)));
        }));
    }
    /**
    ...
    postRecipientBanks(accountId, bankData, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.postRecipientBanks(rsp)));
        }));
    }
    /**
    ...
    postTransfers(accountId, transferData, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.postTransfers(rsp)));
        }));
    }
}
...
class ObservableAssetsApi {
    ...
    assetsAssetIdGet(assetId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.assetsAssetIdGet(rsp)));
        }));
    }
    /**
     * Returns the requested asset, if found
    ...
    assetsSymbolGet(symbol, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.assetsSymbolGet(rsp)));
        }));
    }
    /**
     * Returns all assets
    ...
    getAssets(options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getAssets(rsp)));
        }));
    }
}
...
class ObservableCalendarApi {
    ...
    calendarGet(start, end, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.calendarGet(rsp)));
        }));
    }
}
...
class ObservableClockApi {
    ...
    clockGet(options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.clockGet(rsp)));
        }));
    }
}
...
class ObservableDocumentsApi {
    ...
    accountsAccountIdDocumentsDocumentIdDownloadGet(accountId, documentId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsAccountIdDocumentsDocumentIdDownloadGet(rsp)));
        }));
    }
    /**
    ...
    accountsAccountIdDocumentsGet(accountId, startDate, endDate, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.accountsAccountIdDocumentsGet(rsp)));
        }));
    }
    /**
     * The operation returns a pre-signed downloadable link as a redirect with HTTP status code 301 if one is found.
    ...
    documentsDocumentIdGet(documentId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.documentsDocumentIdGet(rsp)));
        }));
    }
}
...
class ObservableEventsApi {
    ...
    eventsJournalsStatusGet(since, until, sinceId, untilId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.eventsJournalsStatusGet(rsp)));
        }));
    }
}
...
class ObservableJournalsApi {
    ...
    deleteJournal(journalId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteJournal(rsp)));
        }));
    }
    /**
     * Query Params Rules: - `since` required if `until` specified - `since_id` required if `until_id` specified - `since` and `since_id` can’t be used at the same time Behavior: - if `since` or `since_id` not specified this will not return any historic data - if `until` or `until_id` reached stream will end (status 200)
    ...
    getJournals(after, before, status, entryType, toAccount, fromAccount, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getJournals(rsp)));
        }));
    }
    /**
    ...
    postJournals(journalData, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.postJournals(rsp)));
        }));
    }
    /**
    ...
    postJournalsBatch(batchJournalRequest, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.postJournalsBatch(rsp)));
        }));
    }
}
...
class ObservableOAuthApi {
    ...
    oauthAuthorizePost(inlineObject1, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.oauthAuthorizePost(rsp)));
        }));
    }
    /**
    ...
    oauthClientsClientIdGet(clientId, responseType, redirectUri, scope, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.oauthClientsClientIdGet(rsp)));
        }));
    }
    /**
    ...
    oauthTokenPost(inlineObject, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.oauthTokenPost(rsp)));
        }));
    }
}
...
class ObservablePortfolioApi {
    ...
    getPortfolioHistory(accountId, period, timeframe, dateEnd, extendedHours, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getPortfolioHistory(rsp)));
        }));
    }
    /**
    ...
    getPositions(accountId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getPositions(rsp)));
        }));
    }
}
...
class ObservableTradingApi {
    ...
    deleteOrder(accountId, orderId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteOrder(rsp)));
        }));
    }
    /**
    ...
    deleteOrders(accountId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.deleteOrders(rsp)));
        }));
    }
    /**
    ...
    getOrder(accountId, orderId, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getOrder(rsp)));
        }));
    }
    /**
    ...
    getOrders(accountId, status, limit, after, until, direction, nested, symbols, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.getOrders(rsp)));
        }));
    }
    /**
    ...
    patchOrder(accountId, orderId, patchOrder, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.patchOrder(rsp)));
        }));
    }
    /**
    ...
    postOrders(accountId, createOrder, options) {
        ...
        return middlewarePreObservable
            ...
            return middlewarePostObservable.pipe(rxjsStub_1.map((rsp) => this.responseProcessor.postOrders(rsp)));
        }));
    }
}
