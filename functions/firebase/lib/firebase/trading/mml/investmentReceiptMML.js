...
const investmentReceiptMML = (tradeData) => {
    ...
    const mmlmessage = {
        ...
        $${tradeData.notional} of ${tradeData.symbol} ${isSell_1.isSell(tradeData.type) ? "sold" : "purchased"} for ${currencySymbols_1.currencySymbols[tradeData.assetCurrency]}${tradeData.stockPrice} per share.
