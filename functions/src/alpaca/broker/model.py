...
#   datamodel-codegen --input broker/openapi.yaml --output model.py --target-python-version 3.9 --use-generic-container-types --strict-nullable  --use-schema-description
