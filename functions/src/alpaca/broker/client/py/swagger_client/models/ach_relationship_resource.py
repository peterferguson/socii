...
class ACHRelationshipResource(IdentifiedResource):
    ...
    def __init__(self, account_owner_name=None, bank_account_type=None, bank_account_number=None, bank_routing_number=None, nickname=None, account_id=None, status=None, *args, **kwargs):  # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["QUEUED", "APPROVED", "PENDING", "CANCEL_REQUESTED"]  # noqa: E501
