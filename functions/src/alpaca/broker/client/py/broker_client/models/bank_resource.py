...
class BankResource(IdentifiedResource):
    ...
    def bank_code(self, bank_code):
        ...
        if bank_code is None:
            raise ValueError(
                "Invalid value for `bank_code`, must not be `None`"
            )  # noqa: E501
    ...
    def bank_code_type(self, bank_code_type):
        ...
        if bank_code_type is None:
            raise ValueError(
                "Invalid value for `bank_code_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["ABA", "BIC"]  # noqa: E501
        if bank_code_type not in allowed_values:
            raise ValueError(
                "Invalid value for `bank_code_type` ({0}), must be one of {1}".format(  # noqa: E501
                    bank_code_type, allowed_values
                )
            )
