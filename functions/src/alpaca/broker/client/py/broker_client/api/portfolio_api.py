...
class PortfolioApi(object):
    ...
    def get_portfolio_history(self, account_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_portfolio_history_with_http_info(
                account_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_portfolio_history_with_http_info(
                account_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_portfolio_history_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        if "account_id" not in params or params["account_id"] is None:
            raise ValueError(
                "Missing the required parameter `account_id` when calling `get_portfolio_history`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/trading/accounts/{account_id}/account/portfolio/history",
            "GET",
            path_params,
            query_params,
            header_params,
