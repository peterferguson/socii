...
export class AssetsApi extends runtime.BaseAPI {
     ...
     */
    async assetsAssetIdGetRaw(requestParameters: AssetsAssetIdGetRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.assetId === null || requestParameters.assetId === undefined) {
            throw new runtime.RequiredError('assetId','Required parameter requestParameters.assetId was null or undefined when calling assetsAssetIdGet.');
        }
        ...
        const response = await this.request({
            path: `/assets/{asset_id}`.replace(`{${"asset_id"}}`, encodeURIComponent(String(requestParameters.assetId))),
            method: 'GET',
     ...
     */
    async assetsSymbolGetRaw(requestParameters: AssetsSymbolGetRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.symbol === null || requestParameters.symbol === undefined) {
            throw new runtime.RequiredError('symbol','Required parameter requestParameters.symbol was null or undefined when calling assetsSymbolGet.');
        }
        ...
        const response = await this.request({
            path: `/assets/{symbol}`.replace(`{${"symbol"}}`, encodeURIComponent(String(requestParameters.symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async getAssetsRaw(): Promise<runtime.ApiResponse<Array<AssetResource>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(AssetResourceFromJSON));
    }
