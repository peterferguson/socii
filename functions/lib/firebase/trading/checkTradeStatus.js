...
const checkTradeStatus = async (change, context) => {
    ...
    if (event == "fill") {
        ...
        await channel.sendMessage((0, investmentReceiptMML_1.investmentReceiptMML)(tradeData));
        if (tradeData.side == "buy") {
            (0, journalShares_js_1.journalShares)({
        ...
        await channel.sendMessage((0, investmentFailedMML_1.investmentFailedMML)(tradeData));
    }
};
