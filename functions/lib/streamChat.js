...
const invest_1 = require('./commands/invest/invest')
...
`
  ...
  switch (action) {
    case 'confirm':
      ...
      message.mml = invest_1.confirmFormMML(message.args, reportedBy)
    ...
    default:
      ...
      message.mml = invest_1.investFormMML(message.args, user.name)
  }
  if (message.mml !== null) {
    message.text =
