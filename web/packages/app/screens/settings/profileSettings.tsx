    ...
    <View style={tw`flex flex-row justify-center`}>
      ...
      >
        ...
        <Text style={tw`text-center text-pink-400 pb-3`} >
          For now you can change your username.. other options will be enabled soon - keep an eye on our social media for future releases!
        </Text>
        ...
        <ScrollView style={tw`h-11/12 p-2`}>
          ...
          >
            {/* // displayName */}
            <Text style={tw`text-brand-black text-lg dark:text-white pb-1`}> Username </Text>
            ...
            {/* // Website */}
            <Text style={tw`text-brand-black text-lg dark:text-white pb-1 pt-2`}> Website </Text>
            <View style={tw`flex flex-row `}>
              <TextInput
            ...
            {/* // About */}
            <Text style={tw`text-brand-black text-lg dark:text-white pb-1 pt-2`}> About </Text>
            <View style={tw`flex flex-row `}>
              <TextInput
