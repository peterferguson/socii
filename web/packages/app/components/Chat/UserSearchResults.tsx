...
import { Avatar, CheckSend, Close, useTheme, vw } from "stream-chat-expo"
...
type UserSearchResultsProps = {
  ...
  results?: UserResponse<UserType>[]
  showOnlineStatus?: boolean
  toggleSelectedUser?: (user: UserResponse<UserType>) => void
}
