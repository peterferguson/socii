...
import { usePaginatedUsers, useStreamChatTheme } from "app/hooks"
import { UserType } from "app/models/stream/types"
import React, { useState } from "react"
import { ActivityIndicator, StyleSheet, Text, TextInput, View } from "react-native"
import { useSafeAreaInsets } from "react-native-safe-area-context"
import type { UserResponse } from "stream-chat"
import { CircleClose, Search } from "stream-chat-expo"
import {
  isAddMemberBottomSheetData,
  useBottomSheetOverlayContext,
} from "./context/BottomSheetOverlayContext"
import { useChatOverlayContext } from "./context/ChatOverlayContext"
import { UserSearchResultsGrid } from "./UserSearchResultsGrid"
...
export const AddMemberBottomSheet: React.FC = () => {
  ...
  const addMember = async (user: UserResponse<UserType>) => {
