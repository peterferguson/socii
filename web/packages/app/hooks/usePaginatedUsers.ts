// ! Adapted from https://github.com/GetStream/react-native-samples/blob/b077de1278bf1a791927f7f85d65a2dc712783cb/projects/iMessageClone/src/hooks/usePaginatedUsers.ts
...
export function usePaginatedUsers(): PaginatedUsers {
  ...
  const loadMore = () => fetchUsers(searchText)
