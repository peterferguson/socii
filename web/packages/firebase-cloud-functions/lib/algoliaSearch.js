...
exports.onTickerCreated = exports.loadTickersToAlgolia = void 0;
...
const client = (0, algoliasearch_1.default)(ALGOLIA_ID, ALGOLIA_ADMIN_KEY);
/**
 * HTTP function to do an initial load of tickers in /tickers/:documentId/ to the
 * the search index.
 */
const loadTickersToAlgolia = async (req, res) => {
...
exports.loadTickersToAlgolia = loadTickersToAlgolia;
/**
 ...
 */
const onTickerCreated = (snap, context) => {
...
exports.onTickerCreated = onTickerCreated;
